    ...
    <Layout user={user} onLogout={onLogout}>
      ...
      >
        <div>
          ...
          <p className="text-gray-400">Module Incidents en cours de développement</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-12 text-center">
          ...
          <h2 className="text-2xl font-bold text-white mb-4">Module Incidents</h2>
